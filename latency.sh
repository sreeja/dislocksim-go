...
docker exec -it houston tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.21.0.71 flowid 1:2
docker exec -it houston tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.21.0.81 flowid 1:3
...
docker exec -it paris tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.21.0.81 flowid 1:3
...
docker exec -it singapore tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.21.0.71 flowid 1:3
...
docker exec -it etcd-houston tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.21.0.71 flowid 1:2
docker exec -it etcd-houston tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.21.0.81 flowid 1:3
...
docker exec -it etcd-paris tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.21.0.81 flowid 1:3
...
docker exec -it etcd-singapore tc filter add dev eth0 parent 1:0 protocol ip u32 match ip dst 172.21.0.71 flowid 1:3
